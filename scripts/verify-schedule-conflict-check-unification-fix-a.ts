...
if (sharedHelperExists) {
  ...
  check('Shared helper checks teacher conflict', sharedHelper.includes('teacherId') && (sharedHelper.includes('teacher') || sharedHelper.includes('Teacher')))
  check('Shared helper checks class conflict', sharedHelper.includes('classGroupIds') && (sharedHelper.includes('classGroup') || sharedHelper.includes('Class')))
  check('Shared helper checks room conflict', sharedHelper.includes('roomId') && (sharedHelper.includes('room') || sharedHelper.includes('Room')))
  check('Shared helper uses pure rules kernel', sharedHelper.includes('findRuleMatches'))
  check('Shared helper imports expandWeeks for week overlap', sharedHelper.includes('expandWeeks'))
